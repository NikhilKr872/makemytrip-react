        ...
        return (
            ...
            <div className='w-75 mx-auto d-flex flex-column bg-light rounded p-3 shadow-sm' style={{ gap: "10px" }}>
                <div className='d-flex flex-row ' style={{ gap: "10px" }}>
                    ...
                    <label>
                        <input type="checkbox" name="typeOfTravel" className='m-1' onChange={this.toggleTransfer}/>
                        AIRPORT TRANSFERS
                    </label>

                </div>
               {
               !this.state.AirportTransfers? <div className='d-flex flex-row justify-content-start align-items-center' style={{ gap: "10px" }}>
