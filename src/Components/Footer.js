    ...
    render() {
        return (
            <div className='d-flex flex-column w-75 mx-auto'>
                <div className='d-flex flex-row justify-content-around bg-light p-3 shadow-sm' style={{gap:"20px"}}>
                ...
                <div className='d-flex flex-row justify-content-between bg-dark p-3 shadow-sm'>
